...
RouteBase get $homeRoute => GoRouteData.$route(
      ...
      routes: [
        GoRouteData.$route(
          path: 'recipes',
          factory: $RecipesRouteExtension._fromState,
          routes: [
            GoRouteData.$route(
              path: ':id',
...
extension $RecipesRouteExtension on RecipesRoute {
  static RecipesRoute _fromState(GoRouterState state) => RecipesRoute();
...
extension $RecipeDetailRouteExtension on RecipeDetailRoute {
  ...
  String get location => GoRouteData.$location(
        '/recipes/${Uri.encodeComponent(id.toString())}',
      );
...
String _$routerHash() => r'89b9aa1e9a22904da98bada88407819a05cf988b';
